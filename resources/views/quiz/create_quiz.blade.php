...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-8">
            <form class="row g-3" method="post" action="{{route('create_quiz_set')}}">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                    ...
                    <input type="time" class="form-control" id="start_time" name="start_time" placeholder="00:00">
                </div>
                <div class="col-md-4">
                    <label for="end_time" class="form-label">ساعت پایان</label>
                <input type="time" class="form-control" id="end_time" name="end_time" placeholder="00:00">
                </div>
                <div class="col-12">
